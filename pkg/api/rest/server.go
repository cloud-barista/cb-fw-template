...
import (
	...
	"github.com/cloud-barista/cb-fw-template/pkg/api/rest/router"
	...
	_ "github.com/cloud-barista/cb-fw-template/pkg/api/rest/swaggerDocs"
	echoSwagger "github.com/swaggo/echo-swagger"
)

// Server connects REST API endpoints to the route functions
func Server() {
	// Echo instance
	e := echo.New()
	...
	e.GET(*config.Config.RootURL+"/healthcheck", router.HealthCheck)
